...
// Partículas decorativas fixas ao redor do círculo (simulam a "comemoração" do mockup)
const particles = [
    ...
    <div className="flex flex-col h-full bg-white">
      ...
      <div className="px-5 pt-3 shrink-0">
        <div className="flex justify-between items-center text-gray-800 text-xs font-semibold">
          ...
          <div className="flex items-center gap-1">
            ...
            <svg width="15" height="11" viewBox="0 0 24 24" fill="none" stroke="#1f2937" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="flex-1 flex flex-col items-center justify-between px-6 py-6">
        ...
        <div className="flex-1 flex flex-col items-center justify-center w-full relative">
          ...
          <div className="w-28 h-28 rounded-full bg-[#16a34a] flex items-center justify-center shadow-lg shadow-green-200 mb-8">
            <Check size={56} className="text-white" strokeWidth={3} />
          </div>

          {/* Títulos */}
          <h1 className="text-gray-900 text-[26px] font-extrabold text-center leading-tight mb-3">
            Compra realizada<br />com sucesso!
          </h1>
          <p className="text-gray-500 text-[16px] text-center leading-snug">
          ...
          <div className="w-full mt-8 bg-gray-50 border border-gray-100 rounded-2xl px-6 py-5 flex flex-col items-center gap-2 shadow-sm">
            <p className="text-gray-400 text-[13px]">Valor pago</p>
            <p className="text-gray-900 text-[32px] font-extrabold leading-tight">
              R$ 15,00
            </p>
            ...
            <p className="text-gray-400 text-[12px] text-center font-mono tracking-wide">
              ID da transação:{" "}
        ...
        <Link
          ...
          className="w-full bg-[#16a34a] hover:bg-[#15803d] active:scale-[0.98] transition-all text-white text-[17px] font-bold text-center py-4 rounded-2xl shadow-md shadow-green-200 mt-6 block"
        >
          Voltar ao início
        </Link>
      </div>
